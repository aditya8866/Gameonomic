  ...
  return (
    <section
      className={`mx-auto block h-[600px] max-sm:h-[400px] 
        overflow-hidden  bg-white dark:bg-black ${className} `}
    >
      <div
        ...
        <div className="w-full overflow-hidden scale-90 sm:scale-100 ">
          <div
            className={`relative grid h-full w-full origin-center 
              grid-cols-4 sm:grid-cols-${cols} gap-6 transform 
              `}
          >
                ...
                {imagesInGroup.map((image, imgIdx) => {
                  ...
                  return (
                    <div key={`img-${imgIdx}`} className="relative">
                      <div className="absolute top-0 left-0 w-full h-0.9 bg-gray-200 dark:bg-gray-700 " />
                      <motion.img
                        whileHover={{ y: -10 }}
                        ...
                        width={970}
                        height={700}
                        className={`aspect-[970/700] w-full max-w-[300px] rounded-lg object-cover ring ring-gray-300/30 dark:ring-gray-800/50 shadow-xl hover:shadow-2xl transition-shadow duration-300 ${
